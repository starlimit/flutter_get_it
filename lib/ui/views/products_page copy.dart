...
class ProductPage1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('in build');
    var productList = Provider.of<List<ProductModel>>(context);

    return SafeArea(
      child: Center(
          child: productList == null
              ? Container(child: CircularProgressIndicator())
              : makeBody(productList)),
    );
  }
...
//   //   return Provider.of<List<ProductModel>>(context, listen: false);
//   // }
...
//     // final productList =
//     //   Provider.of<ProductListVM>(context, listen: false).fetchProducts();
...
//       // onRefresh: () => getProductList(            context), //model1.fetchProducts(), // getProductList(context),
//       child: Center(
//           child: productList == null
//               ? Container(child: CircularProgressIndicator())
//               : makeBody(productList)),
//       // FutureBuilder(
//       //     future: getProductList(context), // myProductsList,
